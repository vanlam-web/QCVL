...
it('keeps management KPI summaries compact above filters', () => {
  ...
  const collapseHoverRule = cssRule('.management-filter-sidebar:hover .management-filter-collapse-button,\n.management-filter-collapse-button:focus-visible')
...
it('keeps dashboard activity sidebar sticky and chart surface modern', () => {
  ...
  expect(cssRule('.dashboard-side-column')).toContain('max-height: calc(100dvh - var(--shell-topbar-block-size) - var(--space-4))')
