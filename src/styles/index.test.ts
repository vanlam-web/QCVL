...
it('keeps purchase receipt workspace side panel aligned with shared filter width and spacing', () => {
  ...
  expect(cssRule('.purchase-receipt-workspace .purchase-receipt-line-cards')).toContain('--pos-line-unit-width: 5rem')
  ...
  expect(cssRule('.purchase-receipt-workspace .purchase-receipt-line-card-row,\n.purchase-receipt-workspace .purchase-receipt-line-card-header')).toContain('min-width: 58rem')
  ...
  expect(cssRule('.purchase-receipt-workspace-totals dt')).toContain('font-weight: 400')
  expect(cssRule('.purchase-receipt-workspace-totals dd')).toContain('font-weight: 800')
