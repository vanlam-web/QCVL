...
export function createSalesMutationRepository(pool:pg.Pool,deps:SalesMutationDeps):Pick<ServerRepository,'cancelSalesDocument'|'updateSalesDocumentNote'>{const {ensureTables,loadDocument,receiptBaseCode,missingGuard}=deps;return{
