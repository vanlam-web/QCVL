...
- `Hàng thành phần` → BOM dùng ngay (`active`, Owner 2026-07-20). Bán combo trừ thành phần; không trừ mã combo. **Runtime 2026-07-20 chưa khớp** — xem `docs/03-BUSINESS-NghiepVu/BOM/README.md` mục 2.
