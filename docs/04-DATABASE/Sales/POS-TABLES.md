...
- `Hàng thành phần` → BOM (**SoT** `active` dùng ngay, Owner 2026-07-20; **runtime** vẫn `draft`). Bán combo trừ thành phần; không trừ mã combo. Path runtime: [Sales README](../../03-BUSINESS-NghiepVu/Sales/README.md).
