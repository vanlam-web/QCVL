...
>
> **Owner 2026-07-22 — đóng phân bill tạm:** bản in/mẫu hiện tại **dùng được tạm**. Không mở code bill mới (Zalo ảnh, gợi ý máy in, HTML editor, snapshot địa chỉ chứng từ) đến khi Owner bảo. Chi tiết đóng băng: [2026-07-22-bill-area-freeze.md](../../superpowers/plans/2026-07-22-bill-area-freeze.md).
...
| §4 Preference theo khách | **Có** | Multi-tick `preferred_bill_templates` + primary đang xem — [plan](../../superpowers/plans/2026-07-22-customer-multi-bill.md) |
| §5 Gợi ý máy in | **Đóng / sau** | Browser print dialog đủ V1 |
| §6–7 Gửi Zalo/Messenger ảnh | **Đóng / sau** | Ngoài V1 bill |
| Layout A4 gần KV xưởng | **Có** | [plan polish](../../superpowers/plans/2026-07-22-bill-a4-kv-polish.md) |
