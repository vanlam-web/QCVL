...
>
> **Owner 2026-07-22 — đóng phân bill tạm:** bản in/mẫu hiện tại **dùng được tạm**. Không mở code bill mới (Zalo ảnh, gợi ý máy in, HTML editor, snapshot địa chỉ chứng từ) đến khi Owner bảo. Chi tiết đóng băng: [2026-07-22-bill-area-freeze.md ](../../PROJECT-COORDINATION.md).
...
## 10. Trạng thái triển khai (cập nhật 2026-07-22 — đóng tạm)

> **Phạm vi V1 bill = đã xong / đóng.** Agent không mở slice bill mới trừ khi Owner yêu cầu.
...
| §4 Preference theo khách | **Có** | Multi-tick `preferred_bill_templates` + primary đang xem — [plan ](../../PROJECT-COORDINATION.md) |
| §5 Gợi ý máy in | **Đóng / sau** | Browser print dialog đủ V1 |
| §6–7 Gửi Zalo/Messenger ảnh | **Đóng / sau** | Ngoài V1 bill |
| Layout A4 gần KV xưởng | **Có** | [plan polish ](../../PROJECT-COORDINATION.md) |
...
Tham chiếu đối chiếu KV/Sapo/ERPNext/Odoo: [kiotviet-bill-template-reference.md ](../../PROJECT-COORDINATION.md)

### Acceptance V1 (đã đạt để đóng)

1–6, 10 của §9. Mục 7–9 (máy in / gửi ảnh) = nâng cấp sau, không chặn đóng V1.
