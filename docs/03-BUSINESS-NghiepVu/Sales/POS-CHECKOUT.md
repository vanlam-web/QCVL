...
| **Loại 3 (Combo/BOM)** | Trừ từng vật tư thành phần theo BOM của dòng hàng. **Không** trừ tồn theo mã combo. BOM lấy từ combo có sẵn (gồm BOM active import từ KiotViet) hoặc do nhân viên thêm/sửa ngay trong POS cho riêng dòng đó |
...
**Owner 2026-07-20:** Combo không quản lý tồn riêng. Bán combo chỉ trừ thành phần; không sản xuất sẵn trước khi bán.
