...
| Bill Preview / in HD | **Có** (A4 + K80) | Sau tạo HD từ POS + `Xem/In` Sales Documents; toolbar chọn mẫu; Thiết lập: thông tin cửa hàng + mẫu mặc định (localStorage máy này); chưa editor KV / Zalo — [POS-BILL-PRINT-MESSAGING](./POS-BILL-PRINT-MESSAGING.md) · plan `2026-07-21-bill-templates-tier-b` |
