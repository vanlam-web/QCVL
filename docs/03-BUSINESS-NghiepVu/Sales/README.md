...
| Bill Preview / in HD | **Có** (A4 + K80) | Sau tạo HD từ POS + `Xem/In` Sales Documents; toolbar chọn mẫu; Thiết lập shop + mẫu mặc định **lưu server** (`GET/PATCH /api/v1/organization/bill-settings`); chưa editor KV / Zalo — [POS-BILL-PRINT-MESSAGING](./POS-BILL-PRINT-MESSAGING.md) |
