...
Combo phẳng cấp 1 (BOM active từ danh mục hoặc từ dòng POS) dùng ngay khi chốt hóa đơn và trừ thành phần theo Owner 2026-07-20. Combo lồng nhiều cấp/deep-scan phức tạp vẫn để phase sâu hơn khi DB/API đủ.
