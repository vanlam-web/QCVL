...
- [x] Bill Preview: Quản lý mẫu in (tiêu đề/chân/cột/logo) + A4/K80 + Postgres; nhớ mẫu theo khách (`preferred_bill_template` trong customer snapshot); chưa editor HTML KV/Zalo · 2026-07-21
