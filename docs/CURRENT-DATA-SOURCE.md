...
- Ngay `2026-07-13`: So Quy KV local co `TTHD011152` va `TTHD011149`, nhung Sales Documents QCVL cung ngay hien la hoa don POS test `HD-POS...`; do do khong duoc dung du lieu ngay nay de ket luan lech tien/no cho den khi import them hoa don KV ngay hom nay hoac xoa dung pham vi dong cashbook KV ngay hom nay.
