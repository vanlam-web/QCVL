...
| BOM/dinh muc vat tu nhieu cap | SoT: combo phang cap 1 + BOM KV active dung ngay (Owner 2026-07-20). Runtime chua khop. Deep-scan nhieu cap = phase sau. Xem docs/03-BUSINESS-NghiepVu/BOM/README.md |
