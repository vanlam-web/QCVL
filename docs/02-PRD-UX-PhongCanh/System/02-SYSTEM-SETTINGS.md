...
| Hàng hóa nền | Đơn vị tính, nhóm hàng, phương pháp giá vốn tham khảo; BOM KV theo SoT Owner 2026-07-20 (dùng ngay khi bán combo — runtime chưa khớp, xem BOM README); không copy cấu hình sản xuất KiotViet | Chi tiết: Inventory/PriceBook/BOM |
...
| Sản xuất hàng hóa | Không copy nguyên KiotViet. **SoT:** BOM/định mức — import KV dùng ngay, bán combo trừ thành phần, không sản xuất sẵn (Owner 2026-07-20). **Runtime chưa khớp.** Deep-scan/UI cấu hình sâu = phase sau |
