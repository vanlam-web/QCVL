...
> SoT / runtime: [Inventory README](../../03-BUSINESS-NghiepVu/Inventory/README.md) mục 2–3. **V1 freeze 2026-07-14:** roll/sheet object dormant.

- **Runtime 2026-07-20:** `GET /inventory/rolls` và `/sheets` là sample/stub; chưa có CRUD object + movement theo object vận hành thật trên Postgres.
- UI có thể còn entry điểm / tab xem trước — **không** đồng nghĩa đã quản lý tồn object.
- Mục tiêu PRD (object-level, reason khi sửa, chuẩn hóa từ tồn KV tạm) giữ ở mục dài hạn; không viết như đã ship.
