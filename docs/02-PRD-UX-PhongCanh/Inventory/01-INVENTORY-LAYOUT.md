...
| BOM/Vật tư cấu thành | Nhập/sửa định mức. **SoT Owner 2026-07-20:** BOM KV dùng ngay; không cảnh báo “cần rà soát trước khi kích hoạt”. **Runtime:** UI có thể còn “BOM nháp KiotViet” / `draft_bom`; `GET/POST .../bom` stub — [Sales README](../../03-BUSINESS-NghiepVu/Sales/README.md) · [DOC-CLEANUP-CHECKLIST](../../DOC-CLEANUP-CHECKLIST.md) |
