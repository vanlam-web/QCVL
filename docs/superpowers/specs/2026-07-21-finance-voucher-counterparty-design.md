...
Status: **partially implemented (2026-07-21)**. Slice đã làm: nút `Tạo mới` trên form phiếu thu/chi mở tạo nhanh **Khách hàng** / **Nhà cung cấp** rồi điền lại tên vào phiếu. Chưa làm: bắt buộc `counterparty_id`, đối tác giao hàng, map loại thu/chi → nhóm đối tượng, combobox bắt buộc chọn bản ghi.
