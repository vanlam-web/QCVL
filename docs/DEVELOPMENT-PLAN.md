...
| Phase 5 | Combo/BOM và quản lý vật tư | SoT Owner 2026-07-20 đã chốt; runtime chưa khớp (BOM README mục 2). Deep-scan/cuộn-tấm sâu còn phase riêng |
...
- SoT: Import KV BOM `active` dùng ngay; bán combo chỉ trừ thành phần (Owner 2026-07-20). Runtime chưa khớp. Deep-scan nhiều cấp và sản xuất sẵn không thuộc slice này.
