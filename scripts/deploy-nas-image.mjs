...
if (!confirmed) {
  console.log(JSON.stringify({ mode: 'dry-run', releaseId, imageRef, previousImageRef: previous, archive, staging, requiresSsh: true }, null, 2))
  process.exit(0)
}
...
console.log(JSON.stringify({ mode: 'deployed', previousImageRef: previous, ...manifest, checksum }, null, 2))